...
public class OrderPizza_Sam extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OrderPizza_Sam frame = new OrderPizza_Sam();
	 ...
	 * Create the frame.
	 */
	public OrderPizza_Sam() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 474, 122);
		...
		sl_contentPane.putConstraint(SpringLayout.NORTH, btnNewButton, 6, SpringLayout.SOUTH, textArea);
		...
		sl_contentPane.putConstraint(SpringLayout.NORTH, btnNewButton_2, 6, SpringLayout.SOUTH, textArea);
		sl_contentPane.putConstraint(SpringLayout.WEST, btnNewButton_2, 6, SpringLayout.EAST, btnNewButton_1);
		contentPane.add(btnNewButton_2);
		
		JTextPane textPane = new JTextPane();
		sl_contentPane.putConstraint(SpringLayout.NORTH, textPane, 6, SpringLayout.SOUTH, textArea);
		sl_contentPane.putConstraint(SpringLayout.WEST, textPane, 6, SpringLayout.EAST, btnNewButton_2);
		textPane.setText("\uAC1C\uC218");
		contentPane.add(textPane);
		
		JEditorPane editorPane = new JEditorPane();
		sl_contentPane.putConstraint(SpringLayout.NORTH, editorPane, 6, SpringLayout.SOUTH, textArea);
		sl_contentPane.putConstraint(SpringLayout.WEST, editorPane, 6, SpringLayout.EAST, textPane);

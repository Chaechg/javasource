...
public class ListEx1 {
	public static void main(String[] args) {
		...
		ArrayList<Integer> list2 = new ArrayList<Integer>();  //두 가지 방법 모두 가능
		...
		for (int i = 0; i < list1.size(); i++) {  	//length가 아닌 size를 씀
			System.out.println(list1.get(i));  		//[i]가 아닌 get(i)를 쓴다.
		}
